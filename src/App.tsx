...
const TemperatureHumidityMoistureFetcher = () => {
  ...
  const fetchTemperature = async () => {
      const response = await fetch('http://localhost:8088/getTemperature');
      if (!response.ok) {
  ...
  const fetchHumidity = async () => {
      const response = await fetch("http://localhost:8088/getHumidity");
      if (!response.ok) {
  ...
  const fetchMoisture = async () => {
    const response = await fetch("http://localhost:8088/getMoisture");
    if (!response.ok) {
...
const fetchAverageData  =async () => {
  const response = await fetch("http://localhost:8088/getAverageData")
  if(!response.ok) {
